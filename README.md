<p align="center">
  <img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=12,24,30&height=230&section=header&text=Manasa%20Samaga&fontSize=52&fontColor=ffffff&animation=twinkling" width="100%" />
</p>
...
<table width="100%">
  <tr>
    <td style="background-color: #0D1117; border: 2px solid #00F0FF; border-radius: 12px; padding: 20px;">
      <h3 align="center">🕹️ <font color="#00F0FF">Visitor Interactive Playground</font></h3>
      ...
      <details>
        ...
        <blockquote style="background-color: #161B22; padding: 10px; border-radius: 8px;">
      ...
      <div align="center">
        <a href="https://sarvam-native.netlify.app">
          <img src="https://img.shields.io/badge/🎮_Launch_Interactive_Cursor_Gradient_Demo-Live-00C853?style=for-the-badge&logo=react&logoColor=white" />
        </a>
      </div>
    </td>
  </tr>
...
<div align="center">
  <img src="https://readme-jokes.vercel.app/api?theme=dracula&bgColor=0D1117&borderColor=00F0FF&strokeColor=FF70A6&textColor=00F0FF" alt="Dev Joke" />
</div>
  ...
  <table>
    <tr>
      <td width="50%" valign="top">
        ...
        <p align="center">
          <img src="https://img.shields.io/badge/LangGraph-Stateful_Agents-E11D48?style=flat-square&logo=python&logoColor=white" />
          <img src="https://img.shields.io/badge/LangChain-Orchestration-2563EB?style=flat-square" />
          <img src="https://img.shields.io/badge/Context_Engineering-XML_Pillars-D97706?style=flat-square" />
          <img src="https://img.shields.io/badge/RAG-Grounded_Knowledge-059669?style=flat-square" />
          <img src="https://img.shields.io/badge/JSON_Schema-Function_Calling-7C3AED?style=flat-square" />
        </p>
        <ul>
      ...
      <td width="50%" valign="top">
        ...
        <p align="center">
          <img src="https://img.shields.io/badge/Saaras_STT-Code_Mixed-0284C7?style=flat-square" />
          <img src="https://img.shields.io/badge/Bulbul_TTS-Streaming_Audio-DB2777?style=flat-square" />
          <img src="https://img.shields.io/badge/Sarvam_AI-Indic_Models-16A34A?style=flat-square" />
          <img src="https://img.shields.io/badge/Barge_In-Real_Time_Voice-EA580C?style=flat-square" />
        </p>
        <ul>
          <li><b>Code-Mixed Voice Agents</b>: Turn-taking STT → RAG → LLM → TTS pipelines.</li>
          <li><b>Indic Languages</b>: Multilingual speech recognition & synthesis.</li>
          <li><b>Human-in-the-Loop</b>: Confidence routing & PII redaction.</li>
        </ul>
      </td>
    </tr>
    <tr>
      <td width="50%" valign="top">
        <h4 align="center">🔌 <font color="#FFD700">Developer Protocols & Telemetry</font></h4>
        <p align="center">
          <img src="https://img.shields.io/badge/Model_Context_Protocol-FastMCP-9333EA?style=flat-square" />
          <img src="https://img.shields.io/badge/OpenTelemetry-Cost_%26_Latency-DC2626?style=flat-square" />
          <img src="https://img.shields.io/badge/GAQL_Engine-Query_Parser-0D9488?style=flat-square" />
        </p>
        <ul>
          <li><b>MCP Servers</b>: FastMCP over stdio & streamable-HTTP.</li>
          <li><b>OTel Telemetry</b>: Real-time latency tracking & INR cost estimation.</li>
          <li><b>SDK Codegen</b>: Multi-language snippet generation.</li>
        </ul>
      </td>
      <td width="50%" valign="top">
        <h4 align="center">🧠 <font color="#00E676">Deep Learning & ML</font></h4>
        <p align="center">
          <img src="https://img.shields.io/badge/PyTorch-Deep_Learning-EE4C2C?style=flat-square&logo=pytorch&logoColor=white" />
          <img src="https://img.shields.io/badge/GANs-Generative_Models-4F46E5?style=flat-square" />
          <img src="https://img.shields.io/badge/CNN-Computer_Vision-CA8A04?style=flat-square" />
        </p>
        <ul>
          <li><b>Generative Models</b>: GAN architectures & synthetic data generation.</li>
          <li><b>Computer Vision</b>: Convolutional Neural Networks (CNNs).</li>
          <li><b>Evaluation Harnesses</b>: WER, tool accuracy & groundedness scoring.</li>
        </ul>
      </td>
    </tr>
    <tr>
      <td width="50%" valign="top">
        <h4 align="center">⚙️ <font color="#38BDF8">Backend & Systems</font></h4>
        <p align="center">
          <img src="https://img.shields.io/badge/Python_3.12-FastAPI-3776AB?style=flat-square&logo=python&logoColor=white" />
        ...
        <ul>
          ...
          <li><b>Event Streaming & Cache</b>: Redis memory, Kafka event bus.</li>
          <li><b>Infrastructure</b>: Docker Compose, GitHub Actions CI.</li>
        </ul>
      </td>
      <td width="50%" valign="top">
        <h4 align="center">🎨 <font color="#F43F5E">Fullstack & UI Architecture</font></h4>
        <p align="center">
        ...
        <ul>
          ...
          <li><b>Design System</b>: Modern Glassmorphism & HSL UI styling.</li>
...
<table width="100%">
  <tr>
    <td width="50%" valign="top">
      ...
      <p>
        <img src="https://img.shields.io/badge/LangGraph-E11D48?style=flat-square" />
        ...
        <img src="https://img.shields.io/badge/PostgreSQL-059669?style=flat-square" />
      </p>
    ...
    <td width="50%" valign="top">
      ...
      <p>
        <img src="https://img.shields.io/badge/Sarvam_AI-16A34A?style=flat-square" />
        <img src="https://img.shields.io/badge/Setu_MCP-9333EA?style=flat-square" />
        <img src="https://img.shields.io/badge/Kafka-DC382D?style=flat-square" />
      ...
      <p align="center">
        ...
        <a href="https://sarvam-native.netlify.app/vaani"><b>🌐 Live Demo →</b></a>
      </p>
    </td>
  </tr>
  <tr>
    <td width="50%" valign="top">
      <h3 align="center">⚡ <a href="https://github.com/manasasb2000/context-engineering-studio"><font color="#FFD700">Context Engineering Studio</font></a></h3>
      ...
      <p>
        <img src="https://img.shields.io/badge/Google_Gemini-D97706?style=flat-square" />
        <img src="https://img.shields.io/badge/React_19-61DAFB?style=flat-square" />
    ...
    <td width="50%" valign="top">
      <h3 align="center">🔌 <a href="https://github.com/manasasb2000/setu-mcp"><font color="#00E676">Setu MCP Server</font></a></h3>
      ...
      <p>
        <img src="https://img.shields.io/badge/FastMCP-9333EA?style=flat-square" />
        <img src="https://img.shields.io/badge/OpenTelemetry-DC2626?style=flat-square" />
        <img src="https://img.shields.io/badge/PyPI-3776AB?style=flat-square" />
      </p>
  ...
  <tr>
    <td width="50%" valign="top">
      <h3 align="center">🚀 <a href="https://github.com/manasasb2000/rolloutAI"><font color="#FF4081">RolloutAI</font></a></h3>
      ...
      <p>
        <img src="https://img.shields.io/badge/Next.js_16-000000?style=flat-square" />
        <img src="https://img.shields.io/badge/React_19-61DAFB?style=flat-square" />
        <img src="https://img.shields.io/badge/Tailwind_v4-06B6D4?style=flat-square" />
      </p>
      <p align="center">
        <a href="https://github.com/manasasb2000/rolloutAI"><b>🔗 Code</b></a> · 
        <a href="https://rollout-ai-wheat.vercel.app/"><b>🌐 Live Site →</b></a>
      </p>
    </td>
    <td width="50%" valign="top">
      <h3 align="center">🤖 <a href="https://github.com/manasasb2000/github_agentic_workflow"><font color="#38BDF8">Agentic GitHub Workflow</font></a></h3>
      ...
      <p>
        <img src="https://img.shields.io/badge/Agents-059669?style=flat-square" />
